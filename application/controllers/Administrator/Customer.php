...
class Customer extends CI_Controller
{
    ...
    public function getCustomers()
    {
        ...
        if (isset($data->unitAreaId) && $data->unitAreaId != '') {
            $customerTypeClause .= " and c.unit_area_id = '$data->unitAreaId'";
        }
        if (isset($data->territory_id) && $data->territory_id != '') {
            $customerTypeClause .= " and c.territory_id = '$data->territory_id'";
        }
        $customers = $this->db->query("
            select
                c.*,
                d.District_Name,ua.unit_area_name,tr.territory_name,
    ...
    public function getCustomerDue()
    {
        ...
        if (isset($data->unitAreaId) && $data->unitAreaId != '') {
            $clauses .= " and c.unit_area_id = '$data->unitAreaId'";
        }
        if (isset($data->territory_id) && $data->territory_id != '') {
            $clauses .= " and c.territory_id = '$data->territory_id'";
        }
    ...
    public function getCustomerPayments()
    {
        ...
        $payments = $this->db->query("
            ...
            left join tbl_unit_area ua on ua.unit_area_id = cp.unit_area_id
            left join tbl_territories t on t.territory_id = cp.territory_id
    ...
    function getCustomerLedger()
    {
        ...
        $payments = $this->db->query("
            ...
            where ms.customer_id = '$data->customerId'

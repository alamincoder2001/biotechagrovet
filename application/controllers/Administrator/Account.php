    ...
    public function getCashLedger() {
        ...
        $ledger = $this->db->query("
            ...
            select 
                ...
                concat('Material Sale - ', ms.invoice_no, ' - ', c.Customer_Name, ' - Bill:', ms.sub_total) as description,
                ms.paid as in_amount,
                0.00 as out_amount
            from tbl_material_sales ms
            join tbl_customer c on c.Customer_SlNo = ms.customer_id
            where ms.branch_id = '$this->brunch'
            and ms.status = 'a'
            and ms.sales_date between '$data->fromDate' and '$data->toDate'

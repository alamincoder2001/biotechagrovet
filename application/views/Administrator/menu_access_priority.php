...
<div id="userAccess">
    ...
    <div class="row" id="accessRow">
        <div class="col-md-3">
            ...
            <div class="group">
                <input type="checkbox" id="unitModule" class="group-head" @click="onClickGroupHeads"> <strong>Target</strong>
                <ul ref="unitModule">
                    <!-- <li><input type="checkbox" class="access" value="add-unit" v-model="access"> Add Unit Name</li> -->
                    <li><input type="checkbox" class="access" value="add-unit-area" v-model="access"> Add Unit Area</li>
                    <li><input type="checkbox" class="access" value="add-territory" v-model="access"> Add Unit Territory</li>
                </ul>
            </div>
        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="production">
                    ...
                    <li><input type="checkbox" class="access" value="material_purchase" v-model="access"> Raw Material Purchase</li>
                    <li><input type="checkbox" class="access" value="material_sales" v-model="access"> Raw Material Sales</li>
                    <li><input type="checkbox" class="access" value="material_purchase_record" v-model="access"> Material Purchase Record</li>
                    ...
                    <li><input type="checkbox" class="access" value="materials" v-model="access"> Raw Material Entry</li>
                    <li><input type="checkbox" class="access" value="material_list" v-model="access"> Raw Material List</li>
                    <li><input type="checkbox" class="access" value="material_damage" v-model="access"> Damage Raw Materials</li>
                    <li><input type="checkbox" class="access" value="material_stock" v-model="access"> Raw Material Stock</li>
        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="admin">
                    ...
                    <li><input type="checkbox" class="access" value="shift" v-model="access"> Add Shift</li>

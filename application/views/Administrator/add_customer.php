	...
	<form @submit.prevent="saveCustomer">
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			<div class="col-md-5">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Select Area:</label>
					<div class="col-md-7">
					...
					<div class="col-md-1" style="padding:0;margin-left: -15px;">
						<a href="/add-unit-area" target="_blank" class="add-button"><i class="fa fa-plus"></i></a>
					</div>
				</div>
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Select Territory:</label>
					<div class="col-md-7">
						<v-select v-bind:options="territories" label="territory_name" v-model="selectedTerritory"></v-select>
					</div>
					<div class="col-md-1" style="padding:0;margin-left: -15px;"><a href="/add-territory" target="_blank" class="add-button"><i class="fa fa-plus"></i></a></div>
				</div>
				<!-- <div class="form-group clearfix">
	...
	new Vue({
		...
		methods: {
			...
			saveCustomer() {
				...
				this.customer.unit_area_id = this.selectedUnitArea.unit_area_id;
				this.customer.territory_id = this.selectedTerritory.territory_id;
			...
			editCustomer(customer) {
				...
				this.selectedUnitArea = {
					unit_area_id: customer.unit_area_id,
					unit_area_name: customer.unit_area_name
				}

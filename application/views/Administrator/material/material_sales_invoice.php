<div id="materialSalesInvoice">
    <div style="display:none;" v-bind:style="{display: sales.sales_id == 'undefined' ? 'none' : ''}">
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div id="invoiceContent">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="heading">Material Sales Invoice</div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <table class="details-table">
                                ...
                                <tr v-for="(material, sl) in salesDetails">
                                    ...
                                    <td style="text-align:right;">{{ material.sales_rate }}</td>
                        ...
                        <div class="col-xs-4">
                            <table class="bottom-table">
                                ...
                                <tr>
                                    <td>Total Due</td>
                                    <td>&nbsp;:&nbsp;</td>
                                    <td>{{ parseFloat(sales.previous_due) + parseFloat(sales.due) }}</td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <strong>Total (In Amount): </strong>{{ convertNumberToWords(sales.total) }}
                            <br>
                            <strong>Note: </strong>{{ sales.note }}
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    new Vue({
        ...
        methods: {
            ...
            getSalesDetails() {
                axios.post('/get_material_sales_details', {
                    sales_id: this.salesId
                }).then(res => {

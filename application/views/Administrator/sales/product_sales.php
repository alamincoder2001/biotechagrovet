...
<div id="sales" class="row">
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
		...
		<!-- <div class="row">
			<div class="form-group">
				<label class="col-sm-1 control-label no-padding-right"> Area Name </label>
				<div class="col-sm-2">
			...
			<div class="form-group">
				<label class="col-sm-1 control-label no-padding-right"> Territory </label>
				<div class="col-sm-2">
					<v-select v-bind:options="territories" label="territory_name" v-model="selectedTerritory"></v-select>
				</div>
			</div>
				...
				<div class="widget-main">
					...
					<div class="row">
						<div class="col-sm-5">
							...
							<div class="form-group">
								<label class="col-xs-4 control-label no-padding-right"> Area Name </label>
								<div class="col-xs-8">
									<v-select v-bind:options="unitAreas" v-model="selectedUnitArea" label="unit_area_name" @input="getTerritory"></v-select>
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-4 control-label no-padding-right"> Territory </label>
								<div class="col-xs-8">
									<v-select v-bind:options="territories" label="territory_name" v-model="selectedTerritory" @input="getCustomers"></v-select>
								</div>
							</div>
							<div class="form-group">
...
<script>
	...
	new Vue({
		...
		methods: {
			...
			async getCustomers() {
				if (this.selectedUnitArea.unit_area_id == '' || this.selectedTerritory.territory_id == '') {
					return
				}
			...
			async saveSales() {
				...
				if (this.selectedUnitArea.unit_area_id == '') {
					alert('Unit Area is empty');
					return;
				}
				if (this.selectedTerritory.territory_id == '') {
					alert('Territory Name is empty');
					return;
				}
				...
				this.sales.unit_area_id = this.selectedUnitArea.unit_area_id;
				this.sales.territory_id = this.selectedTerritory.territory_id;
			...
			async getSales() {
				await axios.post('/get_sales', {
					...
					this.sales.unit_area_id = sales.unit_area_id;
					this.sales.territory_id = sales.territory_id;
					...
					this.selectedUnitArea = {
						unit_area_id: sales.unit_area_id,
						unit_area_name: sales.unit_area_name
					};
					this.selectedTerritory = {
						territory_id: sales.territory_id,
						territory_name: sales.territory_name
					};

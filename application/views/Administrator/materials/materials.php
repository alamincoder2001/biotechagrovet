            ...
            <form id="materialForm" class="form-horizontal" v-on:submit.prevent="saveMaterial">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="control-label col-sm-4">Raw Material Id</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1" style="padding: 0;">
                            <a href="/material_category" title="Add New Category" class="btn btn-xs btn-danger"
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4">Raw Material Name</label>
                        <label class="control-label col-sm-1"> : </label>
                        <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4">Sales Rate</label>
                        <label class="control-label col-sm-1"> : </label>
                        <div class="col-sm-6">
                            <input type="text" name="sales_rate" id="sales_rate" v-model="material.sales_rate"
                                class="form-control" placeholder="Sales Rate" required>
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
    ...
    new Vue({
        ...
        data() {
            return {
                columns: [
                    { label: 'Add Date', field: 'created_at', align: 'center', filterable: false },
                    ...
                    { label: 'Reorder Level', field: 'reorder_level', align: 'center' },
                    { label: 'Purchase Rate', field: 'purchase_rate', align: 'center' },
                    { label: 'Sales Rate', field: 'sales_rate', align: 'center' },
        ...
        methods: {
            ...
            editMaterial(material){
                ...
                this.material.sales_rate = material.sales_rate;

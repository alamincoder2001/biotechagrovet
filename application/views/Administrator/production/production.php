                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form id="productForm" v-on:submit.prevent="addToProductCart">
                                    ...
                                    <div class="form-group clearfix">
                                        <label class="col-xs-4 control-label no-padding-right"> Pack Size </label>
                                        <div class="col-xs-8">
                                            <input type="text" id="packSize" placeholder="Pack Size" class="form-control" v-model="selectedProduct.pack_size" readonly/>
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                    ...
                    <table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
                        <thead>
                            <tr>
                                ...
                                <th style="width:45%;color:#000;">Product Name</th>
                                <th style="width:25%;color:#000;">Pack Size</th>
                                <th style="width:5%;color:#000;">Qty</th>
            ...
            addToProductCart(){
                ...
                if(ind > -1){
                    ...
                    let product = {
                        ...
                        pack_size: this.selectedProduct.pack_size,

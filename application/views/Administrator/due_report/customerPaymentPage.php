			...
			<form @submit.prevent="saveCustomerPayment">
				<div class="row">
					<div class="col-md-5 col-md-offset-1">
						...
						<div class="form-group">
							<label class="col-md-4 control-label no-padding-right"> Area Name </label>
							<label class="col-md-1">:</label>
							<div class="col-md-7">
						...
						<div class="form-group">
							<label class="col-md-4 control-label no-padding-right"> Territory </label>
							<label class="col-md-1">:</label>
							<div class="col-md-7">
	...
	new Vue({
		...
		methods: {
			...
			saveCustomerPayment() {
				...
				this.payment.unit_area_id = this.selectedUnitArea.unit_area_id;
				this.payment.territory_id = this.selectedTerritory.territory_id;
			...
			editPayment(payment) {
				...
				this.selectedUnitArea = {
					unit_area_id: payment.unit_area_id,
					unit_area_name: payment.unit_area_name
				}
				this.selectedTerritory = {
					territory_id: payment.territory_id,
					territory_name: payment.territory_name
				}

...
<div class="row" id="customerDueList">
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;">
		...
		<div class="form-group" style="display: none" v-bind:style="{display: searchType == 'area' ? '' : 'none'}">
			<label class="col-sm-1 control-label no-padding-right text-right"> Area</label>
			<div class="col-sm-2">
		...
		<div class="form-group" style="display: none" v-bind:style="{display: searchType == 'area' ? '' : 'none'}">
			<label class="col-sm-1 control-label no-padding-right text-right">Territory</label>
			<div class="col-sm-2">

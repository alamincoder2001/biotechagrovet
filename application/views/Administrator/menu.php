...
?>
	<ul class="nav nav-list">
		...
		<li class="">
			<a href="<?php echo base_url(); ?>module/TargetModule">
				<i class="menu-icon fa fa-area-chart"></i>
				<span class="menu-text">Target Module </span>
			</a>
			<b class="arrow"></b>
		</li>
...
<?php } elseif ($module == 'TargetModule') { ?>
	<ul class="nav nav-list">
		...
		<li>
			<a href="<?php echo base_url(); ?>module/TargetModule" class="module_title">
				<span> Target Module </span>
			</a>
		</li>

		<?php if (array_search("sales_target_entry", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>sales_target_entry">
					<i class="menu-icon fa fa-money"></i>
					<span class="menu-text"> Sale Target Entry </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

		<!-- <?php if (array_search("add-unit", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>add-unit">
		...
		<?php if (array_search("add-unit-area", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>add-unit-area">
					<i class="menu-icon fa fa-plus"></i>
					Add Unit Area
				</a>
				<b class="arrow"></b>
		...
		<?php if (array_search("add-territory", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>add-territory">
					<i class="menu-icon fa fa-plus"></i>
					Add Unit Territory
				</a>
				<b class="arrow"></b>
		...
		<?php if (
			array_search("sale_recovery", $access) > -1
			// || array_search("returnList", $access) > -1
			|| isset($CheckSuperAdmin) || isset($CheckAdmin)
		) : ?>
			<li class="">
				...
				<ul class="submenu">
					<?php if (array_search("sale_recovery", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>sale_recovery">
								<i class="menu-icon fa fa-caret-right"></i>
								Sale And Recovery
							</a>
							<b class="arrow"></b>
...
<?php } elseif ($module == 'ProductionModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("material_sales", $access) > -1  || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>material_sales">
					<i class="menu-icon fa fa-cart-plus"></i>
					<span class="menu-text"> Meterial Sales </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

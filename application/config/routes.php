...
//Material Sales
$route['material_sales'] = 'Administrator/materialSalesController/materialSales';
$route['material_sales/(:any)'] = 'Administrator/materialSalesController/materialSales/$1';
$route['add_material_sales'] = 'Administrator/materialSalesController/addMaterialSales';
$route['update_material_sales'] = 'Administrator/materialSalesController/updateMaterialSales';
$route['delete_material_sales'] = 'Administrator/materialSalesController/deleteMaterialSales';
$route['material_sales_record'] = 'Administrator/materialSalesController/MaterialSalesRecord';
$route['get_material_sales'] = 'Administrator/materialSalesController/getMaterialSales';
$route['get_material_sales_details'] = 'Administrator/materialSalesController/getMaterialSalesDetails';
$route['get_material_sales_details'] = 'Administrator/materialSalesController/getMaterialSalesDetails';
$route['material_sales_invoice/(:any)'] = 'Administrator/materialSalesController/materialSalesInvoice/$1';
$route['get_material_cost'] = 'Administrator/materialSalesController/getMaterialCost';
...
// $route['add-unit'] = 'Administrator/Unit/addUnite';
// $route['save-unite'] = 'Administrator/Unit/saveUnite';
// $route['get-unites'] = 'Administrator/Unit/getUnites';
// $route['delete-unite'] = 'Administrator/Unit/deleteUnite';

$route['add-unit-area'] = 'Administrator/Unit/addUnitArea';
$route['save-unit-area'] = 'Administrator/Unit/saveUnitArea';
$route['get-unit-areas'] = 'Administrator/Unit/getUnitAreas';
$route['delete-unit-area'] = 'Administrator/Unit/deleteUnitArea';

$route['add-territory'] = 'Administrator/Unit/addTerritory';
$route['save-territory'] = 'Administrator/Unit/saveTerritory';
$route['get-territories'] = 'Administrator/Unit/getTerritories';
$route['delete-territory'] = 'Administrator/Unit/deleteTerritory';

$route['sales_target_entry'] = 'Administrator/Unit/index';
$route['save_sale_target'] = 'Administrator/Unit/saveSaleTarget';
$route['check_sale_target'] = 'Administrator/Unit/checkSaleTarget';

//extra route
$route['get_sale_target_month'] = 'Administrator/Unit/getSaleTargetMonth';


//unit reports
$route['sale_recovery'] = 'Administrator/Unit/saleRecovery';
$route['get_sale_target_report'] = 'Administrator/Unit/getSaleTargetReport';

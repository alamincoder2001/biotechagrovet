            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 text-right">
                        ...
                        <strong>Unit Name:</strong> {{ sales.unit_area_name }}<br>
                        <strong>Territory Name:</strong> {{ sales.territory_name }}
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-3" style="padding:0;font-size:12px;">
                                                    <span style="font-weight:bold;">Head Office:</span> <br>
                                                    10 Aarmabag Dhaka-1000
                                                    <p style="margin:0;">
                                                        <span style="font-weight:bold;">Mobile:</span> +88 01711481477 <br>
                                                        <span style="font-weight:bold;">Email:</span> biotechbd10@gmail.com 
                                                    </p>
                                                </div>
                                                <div class="col-xs-3" style="padding:0;font-size:12px;">
                                                    <span style="font-weight:bold;">Corporate office:</span> <br>
                                                    Sahara Center,37/A Level 11<br>
                                                    VIP Road, Kakrail, Dhaka-1000 <br>
                                                    <span style="font-weight:bold;">Email:</span> biotechbd10@gmail.com
                                                </div>
                                                <div class="col-xs-3" style="padding:0;font-size:12px;padding-left: 10px;">
                                                    <span style="font-weight:bold;">Factory:</span> <br>
                                                    Olipur, Adarsha Sadar, Cumilla
                                                    <p style="margin:0;">
                                                        <span style="font-weight:bold;">Phone:</span> 029854424 <br>
                                                        <span style="font-weight:bold;">Fax:</span> 029854424
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="row">
